...
//Left Motors:
motor_group(MotorFL,MotorBL),

//Right Motors:
motor_group(MotorFR,MotorBR),
...
//本機 TANK_ONE_SIDEWAYS_ROTATION：forward 距離直接從右側驅動輪 encoder 取，不會去讀下面這個 port 與 diameter。
PORT22,
...
//先回到 0：使用者反映 6 inches 表現更差，待後續實機微調。
0,
